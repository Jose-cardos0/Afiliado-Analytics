      ...
      <div className="w-full max-w-[440px]">
        ...
        <div className="relative grid grid-cols-2 rounded-[18px] border border-[rgba(255,255,255,0.12)] bg-[linear-gradient(180deg,rgba(255,255,255,0.06)_0%,rgba(255,255,255,0.03)_100%)] p-[4px] shadow-[0_10px_30px_rgba(0,0,0,0.20)] backdrop-blur-[16px]">
          ...
          <button
            ...
            className={`relative z-[1] flex min-h-[58px] flex-col items-center justify-center rounded-[14px] px-[14px] py-[10px] text-center transition-all duration-300 ${
              !quarterly ? 'scale-[0.985]' : ''
            }`}
          >
            <span
              className={`inline-flex items-center gap-[7px] font-['Inter'] text-[14px] font-extrabold transition-all duration-300 ${
                !quarterly ? 'text-[#fff]' : 'text-[rgba(255,255,255,0.72)]'
              }`}
            >
              <span
                aria-hidden="true"
            ...
            <span
              className={`mt-[3px] font-['Inter'] text-[11px] transition-all duration-300 ${
                !quarterly
          ...
          >
            ...
            <span
              className={`mt-[3px] inline-flex items-center rounded-full px-[8px] py-[3px] font-['Inter'] text-[10px] font-extrabold uppercase tracking-[0.04em] transition-all duration-300 ${
                quarterly
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`pointer-events-none absolute -right-[40px] -top-[60px] h-[140px] w-[140px] rounded-full ${
            plan.tone === 'padrao'
        ...
        <a
          href={currentHref}
          className={`relative mb-[24px] flex min-h-[54px] items-center justify-center rounded-[14px] border px-[15px] text-center font-['Inter'] text-[15px] font-bold text-[#fff] no-underline transition-all duration-[220ms] ease-in hover:-translate-y-[3px] hover:border-[rgba(255,255,255,0.22)] hover:bg-[rgba(255,255,255,0.14)] ${
            plan.tone === 'padrao'
    ...
    <section id="pricing" className="relative overflow-hidden px-[28px] py-10 sm:py-18">
      ...
      <div className="relative mx-auto max-w-[1120px]">
        ...
        >
          ...
          <p className="mx-auto mb-[35px] max-w-[560px] font-['Inter'] text-[17px] leading-[1.7] text-[rgba(255,255,255,0.64)]">
